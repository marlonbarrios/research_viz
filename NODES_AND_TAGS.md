# Network graph: tags and nodes

Generated from `apps.json`.
...
### Embodied_Interaction (`embodied-interaction`)
...
|----|------|-------------|-------|-----|
| `dark-enlightenment-rave-playlist` | Dark Enlightenment Video Playlists | Dark Enlightenment Playlist | `linkOnly`; `linkTo` → unstable-landscapes only | https://www.youtube.com/watch?v=gTnYNPA-55o&list=PLC2ijZ2U-avi_CB1NQFV6og2eg7ZTpWo3 |
...
| `proteus-temporal` | Proteus: Trans Temporal Dating Portal | Proteus | `linkTo` → `llm` | https://github.com/marlonbarrios/proteus |
